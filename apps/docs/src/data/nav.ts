...
export const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Carousel",          href: "/docs/components/carousel",          badge: "soon" },
      ...
      { title: "Empty State",       href: "/docs/components/empty-state",       badge: "soon" },
      { title: "Field",             href: "/docs/components/field"             },
      { title: "Form",              href: "/docs/components/form",              badge: "soon" },
      { title: "Input",             href: "/docs/components/input"             },
      { title: "Item",              href: "/docs/components/item"              },
      { title: "Kanban",            href: "/docs/components/kanban"            },
      { title: "Label",             href: "/docs/components/label"             },
      { title: "Modal",             href: "/docs/components/modal"             },
      { title: "Number Input",      href: "/docs/components/number-input",      badge: "soon" },
      { title: "OTP Input",         href: "/docs/components/otp-input",         badge: "soon" },
      ...
      { title: "Stat",              href: "/docs/components/stat",              badge: "soon" },
      { title: "Stepper",           href: "/docs/components/stepper",           badge: "soon" },
      { title: "Switch",            href: "/docs/components/switch"            },
      { title: "Table",             href: "/docs/components/table"             },
      { title: "Tabs",              href: "/docs/components/tabs"              },
      { title: "Tag",               href: "/docs/components/tag"                               },
      { title: "Tags Input",        href: "/docs/components/tags-input"                        },
      { title: "Timeline",          href: "/docs/components/timeline",          badge: "soon" },
      { title: "Toast",             href: "/docs/components/toast"             },
      { title: "Toggle Group",      href: "/docs/components/toggle-group",      badge: "soon" },
      { title: "Tooltip",           href: "/docs/components/tooltip"           },
      { title: "Tree",              href: "/docs/components/tree",              badge: "soon" },
